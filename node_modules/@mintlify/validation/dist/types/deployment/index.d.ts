...
import { EditorPermissionsType } from './editor.js';
...
export type StaticPropsDeploymentType = Pick<DeploymentType, 'basePath' | 'customDomains' | 'disableAiChat' | 'entitlements' | 'featureFlags' | 'feedback' | 'inkeep' | 'isWhiteLabeled' | 'mintConfig' | 'subdomain' | 'trieve' | 'userAuth' | 'docsConfig' | 'assistant'> & {
